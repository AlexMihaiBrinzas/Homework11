...
public class Main {
    public static void main(String[] args) throws IOException {
        Classroom classroom= new Classroom(ReadingFromFiles.readFileBuffered("File/grades.txt"));
        ...
        ReportGenerator reportGenerator = new ReportGenerator(ReadingFromFiles.readFileBuffered("File/grades.txt"));
